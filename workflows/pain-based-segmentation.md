...
**Lineage: `imported` (arrival 2026-08-10).** Source: "Beyond the ICP: A Guide to
...
original core doc per `docs/lineages.md`; carries conflict **C4** — see the doctrine note
...
**recorded, not resolved**: `docs/lineages.md` C4. What is settled: never blend the two

...
Independently of the clone above, GTM material transferred into `accounts/fenton/` came
by a second path: the same upstream kit was scaffolded into a private repo
(`BlueSkyGTM/fb-gtm-kit`, archived 2026-07-27), then vendored into
`fenton-bookkeeping-os/workspaces/practice/`, where it was extended in use. That
extension history is documented in `DIVERGENCE.md`.

...
> only — skills, playbooks, workflows, docs, tools, the `_template/` stamp, and the
...
|---|---|---|---|---|---|
| `fenton` | Fenton Bookkeeping LLC | engineer | live | 2026-08-06 | `fenton-bookkeeping-os` (private) — the practice runs its own GTM |

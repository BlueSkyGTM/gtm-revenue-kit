...
```
Read motions/skills/icp-scoring/SKILL.md and score [company] given that the [signal name]
signal just fired.
```
...
Apply the PVP standard from motions/skills/signal-to-sequence/SKILL.md —
...
```
Read motions/skills/signal-to-sequence/SKILL.md.

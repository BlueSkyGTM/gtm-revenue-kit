...
- The Pre-Campaign Checklist in `motions/workflows/campaign-build.md` fails on "is the value prop
...
Anything less, and `motions/workflows/campaign-build.md` fails the campaign back here before Phase 1.

...
Run the enrichment workflow (`motions/workflows/enrichment.md`) on the target list.
...
Run the Signal to Sequence skill (`motions/skills/signal-to-sequence/SKILL.md`).

...
For the markets that live outside the standard B2B databases (`motions/tam/skeleton.md`,
...
`motions/playbooks/new-signal-response.md` continuously.
...
- `motions/workflows/enrichment.md` — what to enrich, the waterfall order, and the quality gates
- `motions/tam/skeleton.md` — the market-mapping stage these scraping patterns serve
- `motions/playbooks/new-signal-response.md` — what to do when a news/feed signal fires
- `foundations/pvp.md` — the verification standard every scraped fact must meet before it
  appears in copy

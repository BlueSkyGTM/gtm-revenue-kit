...
Single account:
```
Read motions/skills/icp-scoring/SKILL.md and score [company.com] against our ICP
```

Batch:
```
Read motions/skills/icp-scoring/SKILL.md and accounts/<slug>/context/icp-definition.md.
...
**This section is mechanism. It contains no values on purpose** (`foundations/principles.md` §3).
...
priority decision: it sets research depth and touch count (the account's `scoring-model.md` §4).

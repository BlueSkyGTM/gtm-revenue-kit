...
moment of delivery. Where `motions/plays/06-one-to-one-abm.md` is one operator choosing
...
own. The PVP standard (`foundations/pvp.md`) applies to the follow-up exactly as to any

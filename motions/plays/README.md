...
mechanism only, pass the swap test (`foundations/principles.md`), and carry no company names,
...
`foundations/pvp.md` (PVP, datable "why now", verification) and the account's `scoring-model.md` (tiers, gates).
...
`motions/playbooks/new-signal-response.md`.
...
`motions/playbooks/competitor-switch.md`; 13 can carry the sends of most other plays; 06 is the

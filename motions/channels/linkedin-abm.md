...
- `motions/channels/micro-lists.md` — the same high-touch economics applied to hand-sent
  1:1 outreach; the two playbooks share preconditions
- `motions/channels/cold-email.md` — the volume channel these architectures deliberately
  are not; also the anchor-email mechanics
- `motions/tam/skeleton.md` — people-finding and enrichment for the target lists
- `foundations/pvp.md` — the verification standard; a wrong personalization in a high-touch

...
3. **Score instantly.** Run the logic of `skills/icp-scoring/SKILL.md` inline. Tier bands
...
effortless — a direct link, a concrete time. The PVP standard from `docs/standards.md` still
...
- Funnel diagnostics per `docs/standards.md` for the response sequence itself

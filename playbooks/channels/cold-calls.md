...
- Interested email replies are sitting unworked (`playbooks/channels/cold-email.md` says
  call them first)
...
`workflows/tam-campaign.md` Stage 3.
...
- `playbooks/channels/cold-email.md` — the channel whose interested replies this channel
  calls first
- `workflows/tam-campaign.md` — TAM mapping and people-finding upstream of any call list
- `workflows/enrichment-techniques.md` — the scraping and waterfall mechanics for number
  sourcing
- `docs/standards.md` — funnel diagnostics; the "high reply, low meeting" pattern applies to

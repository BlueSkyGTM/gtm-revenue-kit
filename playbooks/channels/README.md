...
All four assume a list already exists: `workflows/tam-campaign.md` builds it,
`workflows/enrichment.md` qualifies it, and suppression against the account's `optouts.md`
...
Related: `playbooks/deliverability-and-warmup.md` is upstream of any email send — no inbox,
no touch.

...
This is the durable home for warmup knowledge. `workflows/enrichment.md` holds the same standing
...
These are the same rules `workflows/enrichment.md` applies during list build. If an account's
...
- `workflows/enrichment.md` — the same standing infrastructure rules, applied during list build
- `playbooks/new-signal-response.md` — what to do once a signal fires. This playbook is upstream
